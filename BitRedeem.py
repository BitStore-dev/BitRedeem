...
class Console:
    ...
    def update_title() -> None:
        ...
        while True:
            ...
            os.system(
                f"title BitRedeem │ Activated Accounts: {activated_accounts} │ Elapsed: {elapsed_time}"
            )
            thread_lock.release()
                ...
                try:
                    WebDriverWait(self.driver, 25).until(
                        EC.presence_of_element_located(
                            (
                                By.XPATH,
                                "//div[contains(text(),'You now have Server Boosts.')]",
                            )
                        )
                    )
...
if __name__ == "__main__":
    ...
    print(
        Center.XCenter(
            ...
            \______   \__|/  |\______   \ ____   __| _/____   ____   _____  
             |    |  _/  \   __\       _// __ \ / __ |/ __ \_/ __ \ /     \ 
             |    |   \  ||  | |    |   \  ___// /_/ \  ___/\  ___/|  Y Y  \ 
             |______  /__||__| |____|_  /\___  >____ |\___  >\___  >__|_|  / 
                    \/                \/     \/     \/    \/     \/      \/  
